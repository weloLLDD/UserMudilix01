...
const {data} = await axios.post(`https://backmudilix-12.onrender.com/api/users/login`, {email, password},config);
...
export const logout = ()  => async(dispatch)=>{
    ...
    document.location.href="https://backmudilix-12.onrender.com/login";
}
...
const {data} = await axios.post(`https://backmudilix-12.onrender.com/api/users`, {name,email, password},config);
...
// NOUS AVONS MODIFIER ACCIER CODE POUR NOUS CODE DE CONFIG POUR RECUPER LE PROTECT DE JSWEBTOKEN en redux
    ...
    const { data } = await axios.get(`https://backmudilix-12.onrender.com/api/users/${id}`,config);
...
export const updateUserProfile = (user)  => async(dispatch,getState)=>{
  try {
    ...
    const { data } = await axios.put(`https://backmudilix-12.onrender.com/api/users/profile`,user, config);
